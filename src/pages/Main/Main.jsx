...
const section3Contents = [
  {
    ...
    title: "PREMIUM 01",
    text1: `고덕국제화계획지구 프리미엄`,
    text2: `평택 고덕국제화계획지구 Aab-13BL<br/>
            미래가치를 품은 ELIF 브랜드 아파트`,
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `서정리역 생활권 프리미엄`,
    text2: `서정리역 생활권과 주요 도로망 접근성<br/>
            편리한 광역 교통 환경을 누리는 입지`,
  ...
  },
  {
    ...
    title: "PREMIUM 03",
    text1: `풍부한 생활 인프라`,
    text2: `상업시설 · 교육시설 · 생활편의시설<br/>
            일상을 더욱 편리하게 만드는 생활 환경`,
    link: "/LocationEnvironment/intro",
    linkText: "더 알아보기 >",
  },
  {
    ...
    title: "PREMIUM 04",
    text1: `총 996세대 ELIF 브랜드`,
    text2: `전용 59㎡·84㎡ 구성의 브랜드 아파트<br/>
            고덕국제화계획지구의 새로운 주거 가치`,
        ...
        <>
            ...
            <div className={styles.mainImageTextBox}>
              ...
              <div className={styles.mainImageTitleBox}>
                ...
                <div className={styles.mainImageDesc}>
                  평택 고덕국제화계획지구 Aab-13BL에 조성되는<br />
                  전용 59㎡·84㎡, 총 996세대 ELIF 브랜드 아파트<br />
                  서정리역 생활권과 풍부한 생활 인프라를 누리는 프리미엄 주거단지
                </div>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  - 평택 고덕국제화계획지구 Aab-13BL 프리미엄 입지<br />
                  - 총 996세대 ELIF 브랜드 아파트, 전용 59㎡·84㎡ 구성<br />
                  - 서정리역 생활권과 편리한 광역 교통 환경<br />
                  - 생활·교육·상업 인프라를 가까이 누리는 주거 환경<br />
                  - 쾌적한 공원·녹지 공간과 미래가치를 품은 프리미엄 라이프
                </div>
          ...
          <div className={styles.section}>
            <div className={styles.section2}>
              ...
              <img
                src={section2_Image1}
                alt="엘리프 고덕 센트럴하이아파트 조감도-image3"
                loading="lazy"
                decoding="async"
              />
            </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="엘리프 고덕 센트럴하이브랜드소개-image4"
                  loading="lazy"
                  decoding="async"
                />
                <div className={styles.text1}>엘리프 고덕 센트럴하이</div>
          ...
          <div className={styles.pcVisitContainer}>
            ...
            <form
              ...
              action="https://formspree.io/f/mvznyjon"
              method="POST"
            >
              <label htmlFor="name">
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="엘리프 고덕 센트럴하이오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.imageContainer}>
            <img
              src={mobileImageMain}
              className={styles.mainImage}
              alt="엘리프 고덕 센트럴하이 아파트 모바일 메인 이미지"
            />
            ...
            <div className={styles.mainImageTextBox1}>
              ...
              <div className={styles.mainImageTextSub1}>
                평택 고덕국제화계획지구 Aab-13BL<br />
                총 996세대 ELIF 브랜드 아파트<br />
              ...
              <div className={styles.mainImageTitleBox1}>
                ...
                <div className={styles.mainImageDesc1}>
                  평택 고덕국제화계획지구에 조성되는<br />
                  전용 59㎡·84㎡, 총 996세대 ELIF 브랜드 아파트<br />
                  생활 인프라와 미래가치를 모두 누리는 프리미엄 주거단지
                </div>
            </div>
          </div>
        </div>
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 엘리프 고덕 센트럴하이에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="엘리프 고덕 센트럴하이모바일 조감도 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="엘리프 고덕 센트럴하이브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="엘리프 고덕 센트럴하이오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
