...
const menuArray = [
  ...
  },
  {
    title: "단지안내",
    subMenu: [
      { subTitle: "단지설계", subUrl: "/ComplexGuide/intro" },
  ...
  },
  {
    ...
    subMenu: [
      ...
      { subTitle: "89B㎡", subUrl: "/FloorPlan/59B" },
      ...
      <>
        ...
        <div className={styles.mobileHeader}>
          <div onClick={() => setIsMobileMenu((v) => !v)}>
            {!isMobileMenu ? (
              <AiOutlineMenu className={styles.icon} size={25} color="#0f4438" />
            ) : (
              <IoCloseSharp className={styles.icon} size={25} color="#0f4438" />
            )}
          </div>
          {isMobileMenu && (
            <SlideMenu
          ...
          <a href="tel:1533-8848">
            <IoCall className={styles.icon} size={25} color="#0f4438" />
          </a>
        </div>
        {isInterestPopupOpen && (
          <InterestPopup
